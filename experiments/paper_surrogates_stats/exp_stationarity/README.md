...
|----------------|-------------|
| `run_experiment1` | Demonstrates stationarity structure on a custom directed cycle-based graph and visualizes spectral covariance properties |
| `run_experiment2` | Applies surrogate-based stationarity testing on real USA road graph data and plots the detection results |
