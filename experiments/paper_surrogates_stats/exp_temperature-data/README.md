...
|----------------|-------------|
| `run_experiment1` | Visualizes directed and undirected spectral power of demeaned temperature signals and compares their covariance structure |
| `run_experiment2` | Generates surrogate null distributions for directed and undirected stationarity tests on temperature data and computes p-values |
| `run_experiment3` | Plots the surrogate null distributions against observed temperature signals for selected weather stations |
